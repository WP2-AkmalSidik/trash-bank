        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="relative flex-1 max-w-md mx-4">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-400 dark:text-gray-500" fill="none"
                ...
                <input type="text"
                    class="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-primary dark:focus:ring-emerald-500 focus:border-primary dark:focus:border-emerald-500 sm:text-sm"
                    placeholder="Cari...">
            </div>
