...
<div id="loading-overlay" class="fixed left-0 right-0 top-0 flex items-center justify-center z-40 hidden"
...
<div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around p-3 z-50">
    <!-- Beranda -->
    <a href="{{ route('user.dashboard') }}" onclick="showLoading()"
    ...
    <!-- Pengajuan -->
    <a href="{{ route('user.pengajuan') }}" onclick="showLoading()"
    ...
    <!-- Transaksi -->
    <a href="{{ route('user.transaksi') }}" onclick="showLoading()"
    ...
    <!-- Profil -->
    <a href="{{ route('user.profile') }}" onclick="showLoading()"
